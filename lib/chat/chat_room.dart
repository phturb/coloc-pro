      ...
      return Row(
        children: <Widget>[
          Container(
            child: Text(
              document['content'],
              //style: TextStyle(color: const Color(0xff203152);),
            ),
  ...
  Widget buildInput() {
    return Container(
        ...
        children: <Widget>[
          ...
          Flexible(
            child: Container(
              child: TextField(
                style:
                    TextStyle(color: const Color(0xff203152), fontSize: 15.0),
                controller: textEditingController,
                decoration: InputDecoration.collapsed(
                  hintText: 'Type your message...',
                  hintStyle: TextStyle(color: const Color(0xffaeaeae)),
                ),
                focusNode: focusNode,
              ),
            ),
      ...
      decoration: new BoxDecoration(
          border: new Border(
              top: new BorderSide(color: const Color(0xffE8E8E8), width: 0.5)),
          color: Colors.white),
    );
  }
